...
/**
 * Protobuf type {@code drive_protocol.request.MoveFileRequest}
 */
public final class MoveFileRequest extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:drive_protocol.request.MoveFileRequest)
...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 40: {
            ...
            replaceIfExisting_ = input.readBool();
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return drive_protocol.request.Request.internal_static_drive_protocol_request_MoveFileRequest_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return drive_protocol.request.Request.internal_static_drive_protocol_request_MoveFileRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            drive_protocol.request.MoveFileRequest.class, drive_protocol.request.MoveFileRequest.Builder.class);
  }
  ...
  public static final int NEW_FILE_NAME_FIELD_NUMBER = 4;
  ...
  public static final int REPLACE_IF_EXISTING_FIELD_NUMBER = 5;
  private boolean replaceIfExisting_;
  /**
   * <code>bool replace_if_existing = 5;</code>
   * @return The replaceIfExisting.
   */
  @java.lang.Override
  public boolean getReplaceIfExisting() {
    return replaceIfExisting_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(newFileName_)) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 4, newFileName_);
    }
    if (replaceIfExisting_ != false) {
      output.writeBool(5, replaceIfExisting_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(newFileName_)) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(4, newFileName_);
    }
    if (replaceIfExisting_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(5, replaceIfExisting_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof drive_protocol.request.MoveFileRequest)) {
      return super.equals(obj);
    }
    drive_protocol.request.MoveFileRequest other = (drive_protocol.request.MoveFileRequest) obj;
    ...
    if (getReplaceIfExisting()
        != other.getReplaceIfExisting()) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + REPLACE_IF_EXISTING_FIELD_NUMBER;
    hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
        getReplaceIfExisting());
    hash = (29 * hash) + unknownFields.hashCode();
    memoizedHashCode = hash;
    return hash;
  }

  public static drive_protocol.request.MoveFileRequest parseFrom(
  ...
  public static drive_protocol.request.MoveFileRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static drive_protocol.request.MoveFileRequest parseFrom(
  ...
  public static drive_protocol.request.MoveFileRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static drive_protocol.request.MoveFileRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static drive_protocol.request.MoveFileRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(drive_protocol.request.MoveFileRequest prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:drive_protocol.request.MoveFileRequest)
      drive_protocol.request.MoveFileRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return drive_protocol.request.Request.internal_static_drive_protocol_request_MoveFileRequest_descriptor;
    }
    ...
    // Construct using drive_protocol.request.MoveFileRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public drive_protocol.request.MoveFileRequest getDefaultInstanceForType() {
      return drive_protocol.request.MoveFileRequest.getDefaultInstance();
    }

    @java.lang.Override
    public drive_protocol.request.MoveFileRequest build() {
      drive_protocol.request.MoveFileRequest result = buildPartial();
    ...
    @java.lang.Override
    public drive_protocol.request.MoveFileRequest buildPartial() {
      drive_protocol.request.MoveFileRequest result = new drive_protocol.request.MoveFileRequest(this);
      if (reqBuilder_ == null) {
        result.req_ = req_;
      } else {
      ...
      result.replaceIfExisting_ = replaceIfExisting_;
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof drive_protocol.request.MoveFileRequest) {
        return mergeFrom((drive_protocol.request.MoveFileRequest)other);
      } else {
    ...
    public Builder mergeFrom(drive_protocol.request.MoveFileRequest other) {
      if (other == drive_protocol.request.MoveFileRequest.getDefaultInstance()) return this;
      if (other.hasReq()) {
      ...
      if (other.getReplaceIfExisting() != false) {
        setReplaceIfExisting(other.getReplaceIfExisting());
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      drive_protocol.request.MoveFileRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (drive_protocol.request.MoveFileRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    /**
     * <code>bool replace_if_existing = 5;</code>
     * @param value The replaceIfExisting to set.
     * @return This builder for chaining.
     */
    public Builder setReplaceIfExisting(boolean value) {
      
      replaceIfExisting_ = value;
      onChanged();
      return this;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder clearReplaceIfExisting() {
    ...
    // @@protoc_insertion_point(builder_scope:drive_protocol.request.MoveFileRequest)
  }

  // @@protoc_insertion_point(class_scope:drive_protocol.request.MoveFileRequest)
  private static final drive_protocol.request.MoveFileRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new drive_protocol.request.MoveFileRequest();
  }

  public static drive_protocol.request.MoveFileRequest getDefaultInstance() {
  ...
  private static final com.google.protobuf.Parser<MoveFileRequest>
    ...
    public MoveFileRequest parsePartialFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new MoveFileRequest(input, extensionRegistry);
    }
  };
